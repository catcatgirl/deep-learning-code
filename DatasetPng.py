...
class CCTADataset(Dataset):
    ...
    def __init__(self, dir_A, dir_GT, dir_B=None, is_train=True, img_size=256):
        ...
        # self.dir_B = dir_B
        self.dir_GT = dir_GT
        self.is_train = is_train  # 是否训练集（区分是否启用数据增强）
        self.img_size = img_size

        # 所有图片文件名（严格排序保证对齐，保证A/B/GT三张图一一对应）
...
if __name__ == "__main__":
    ...
    # 2. 实例化训练集
    try:
        train_dataset = CCTADataset(train_A, train_GT, is_train=False, img_size=256)
